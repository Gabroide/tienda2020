...
--
-- Servidor: localhost
-- Tiempo de generación: 14-03-2017 a las 11:18:48
...
INSERT INTO `tblproducto` (`idProducto`, `strNombre`, `refCategoria1`, `strImagen1`, `strDescripcion`, `dblPrecio`, `intEstado`, `refMarca`, `refCategoria2`, `refCategoria3`, `refCategoria4`, `refCategoria5`, `strImagen2`, `strImagen3`, `strImagen4`, `strImagen5`, `intPrincipal`, `intStock`, `refImpuesto`, `dblPeso`) VALUES
(1, 'Opel África', 1, 'coche1.jpg', '<p>Coche grande y espacioso</p>', 9800.00, 1, 6, 6, 0, 0, 0, 'cochedetalle.jpg', 'cochedetalle2.jpg', NULL, NULL, 1, 8, 5, 8),
(2, 'Seat América', 1, '', 'Coche muy espacioso', 8100.00, 1, 6, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 2, 0),
(3, '867', 1, NULL, '87', 87.00, 1, 5, 6, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 3, 0),
(4, 'xxxx', 1, NULL, '<p>xscwecfwef</p>', 234.00, 1, 6, 6, 3, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
(5, 'Peugueot Frontera', 1, 'coche2.jpg', '<p>Coche muy interesante</p>', 5600.00, 1, 6, 5, 6, 0, 0, NULL, 'sale.png', 'new.png', NULL, 0, 10, 1, 0),
(6, 'Cabriolo', 1, 'coche4.jpg', '<p>Potencia sin control</p>', 50000.00, 1, 6, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
(7, 'f2e', 1, NULL, 'f2f', 24.00, 1, 0, 1, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
(8, 'Mercedes Calixto', 1, 'coche3.jpg', '<p>Escribir Descripci&oacute;n</p>', 20000.00, 1, 3, 6, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
(9, 'Seat América', 11, NULL, '<p>Coche muy espacioso</p>', 125.00, 1, 0, 0, 6, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
(10, 'Seat África', 6, '0', '<p>Coche grande y espacioso</p>', 123.00, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0);
