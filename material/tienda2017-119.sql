...
--
-- Servidor: localhost
-- Tiempo de generación: 22-03-2017 a las 22:35:48
...
(1, 'Baratos', 'baratos', 1, 0, 1),
(3, 'Outlet', 'outlet', 1, 0, 2),
(4, 'Rápidos', 'rapidos', 1, 0, 54),
(5, 'Último modelo', 'ultimo-modelo', 1, 0, 22222),
(6, 'Volante a la izquierda', 'volante-a-la-izquierda', 1, 1, 2),
(11, 'Volante a la derecha', 'volante-a-la-derecha', 1, 1, 2),
(12, 'Coche Japonés', 'coche-japones', 1, 11, 1);
...
(5, 'Peugueot Frontera', 'peugueot-frontera', 1, 'coche2.jpg', '<p>Coche muy interesante</p>', 5600.00, 0, 1, 6, 5, 6, 0, 0, NULL, 'sale.png', 'new.png', NULL, 0, 10, 1, 0),
...
(10, 'Seat África', 'seat-africa-2', 6, '0', '<p>Coche grande y espacioso</p>', 123.00, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0);
