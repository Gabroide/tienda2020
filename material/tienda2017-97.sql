...
--
-- Servidor: localhost
-- Tiempo de generación: 14-03-2017 a las 11:42:46
...
(1, 'Opel África', 1, 'coche1.jpg', '<p>Coche grande y espacioso</p>', 9800.00, 0, 1, 6, 6, 0, 0, 0, 'cochedetalle.jpg', 'cochedetalle2.jpg', NULL, NULL, 1, 8, 5, 8),
...
(6, 'Cabriolo', 1, 'coche4.jpg', '<p>Potencia sin control</p>', 50000.00, 0, 1, 6, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 1, 10, 1, 0),
...
(1, 'Europa', 1, 0, 0, 0, 0),
(2, 'EEUU', 1, 0, 0, 0, 0),
(3, 'Peso minimo', 1, 2, 0, 10, 30),
(4, 'Pedo Medio', 1, 2, 10, 50, 100),
(5, 'Peso Grande', 1, 2, 50, 100, 120),
(6, 'Peso Gigante', 1, 2, 100, 999999, 125),
(7, 'Zona Única', 1, 1, 0, 999999, 23);
