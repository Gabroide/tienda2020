...
$query_DatosConsulta = sprintf("SELECT DISTINCT(COUNT(idProducto)) AS Totalconsulta FROM tblproducto WHERE intEstado=1 ".$extramarcas." ".$extraprincipal." ".$extraconsulta." ".$bloqueconsultadinamica);
...
$query_DatosConsulta = sprintf("SELECT DISTINCT(idProducto) FROM tblproducto WHERE intEstado=1 ".$extramarcas." ".$extraprincipal." ".$extraconsulta." ".$bloqueconsultadinamica." ORDER BY idProducto ASC LIMIT %s OFFSET %s", $_POST["max"], $Totalmostrados);
