...
if ((isset($_SESSION['tienda2017Front_UserId'])) || (isset($_SESSION['MM2_Temporal'])))
{
	...
	$query_DatosConsulta = sprintf("SELECT * FROM tblcarritoreserva WHERE refUsuario=%s AND intTransaccionEfectuada=0 ",
						$usuariotempoactivo);
...
function MM_jumpMenu(targ,selObj,restore){ //v3.0
  eval(targ+".location='reserva.php?zona="+selObj.options[selObj.selectedIndex].value+"'");
  if (restore) selObj.selectedIndex=0;
}
function MM_jumpMenuImpuesto(targ,selObj,restore){ //v3.0
  eval(targ+".location='reserva.php?impuesto="+selObj.options[selObj.selectedIndex].value+"'");
  if (restore) selObj.selectedIndex=0;
}
    </script>
<!-- InstanceEndEditable -->
...
<section id="cart_items">
		<div class="container">
						...
						<tr>
							...
							<td width="15%">
								<div class="cart_quantity_button">
									<a class="cart_quantity_up" href="reserva-operar.php?id=<?php echo $row_DatosConsulta["idContador"]?>&op=1" title="<?php echo _T119;?>"> + </a>
									...
									<a class="cart_quantity_down" href="reserva-operar.php?id=<?php echo $row_DatosConsulta["idContador"]?>&op=2&actual=<?php echo $row_DatosConsulta["intCantidad"];?>" title="<?php echo _T120;?>"> - </a>
							...
							<td width="20%">
								<p class="cart_total_price"><?php 
									...
									echo number_format($totalcarrito, 2, ",", "").$_SESSION["monedasimbolo"];
							...
							<td width="5%">
								<a class="cart_quantity_delete" href="reserva-operar.php?id=<?php echo $row_DatosConsulta["idContador"]?>&op=3" title="<?php echo _T122;?>"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						<?php 
			...
			<a class="btn btn-default update" href="reserva-operar.php?id=<?php echo $row_DatosConsulta["idContador"]?>&op=4" title="<?php echo _T49;?>"><?php echo _T49;?></a>&nbsp;			
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="chose_area">					
						<form action="pagar.php" method="post">
							...
							<ul class="user_option">
								...
								<?php											
									...
									$query_DatosComprador = sprintf("SELECT * FROM tblreserva WHERE idUsuario=%s ORDER BY idReserva DESC",
															$usuariotempoactivo);
									//echo $query_DatosComprador;
						...
						<br><br><br>
						<p class="atencion"><?php echo _T177;?></p>						
					</div>
				</div>
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							<li><?php echo _T62;?><span><?php echo number_format($totalcarrito, 2, ",", "").$_SESSION["monedasimbolo"];?></span></li>
							<li><?php echo _T46;?><span><?php 
								...
								?></span></li>
							<li><?php echo _T48;?> <span><?php echo number_format($totalcarrito, 2, ",", "").$_SESSION["monedasimbolo"];
								$_SESSION["Total"]=$totalcarrito;
