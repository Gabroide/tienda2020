...
<div class="col-sm-12">
				...
				do {
					?>
					<li <?php if ($primeracatespecial==1){?>class="active"<?php }?>><a href="#cat<?php echo $row_DatosCategoriasPrincipales["idCategoria"];?>" data-toggle="tab"><?php echo $row_DatosCategoriasPrincipales["strNombre_"._idiomaactual];?></a></li>
					<?php
					$primeracatespecial++;
