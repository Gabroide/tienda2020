...
$bloquefinal='</div>
						...
						<a href="#slider-carousel" class="left control-carousel hidden-xs" data-slide="prev" title="'._T110.' '._T112.'">
							<i class="fa fa-angle-left"></i>
						</a>
						<a href="#slider-carousel" class="right control-carousel hidden-xs" data-slide="next" title="'._T110.' '._T111.'">
...
do {
	...
	if ($iniciar==0)
		$bloquecontenido.='<div class="item active">
								<div class="col-sm-6">
									'.$row_Slider["strTexto_"._idiomaactual].'
									<a class="btn btn-default get" href="'._strURL.$row_Slider["strLink_"._idiomaactual].'" title="'._T110.' '.$row_Slider["strNombre_"._idiomaactual].'">'._T72.'</a></button>
								</div>
								<div class="col-sm-6">
									<img src="images/slider/'.$row_Slider["strImagen"].'" class="girl img-responsive" alt="'.$row_Slider["strImagen"].'" />									
								</div>
							</div>';
	else
		$bloquecontenido.='<div class="item">
								<div class="col-sm-6">
									'.$row_Slider["strTexto_"._idiomaactual].'
									<a class="btn btn-default get" href="'._strURL.$row_Slider["strLink_"._idiomaactual].'">'._T72.'</a></button>
								</div>
								<div class="col-sm-6">
									<img src="images/slider/'.$row_Slider["strImagen"].'" class="girl img-responsive" alt="'.$row_Slider["strImagen"].'" />								
								</div>
