...
<head>
    ...
    <title>Administración Tienda | Editar Característica</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="caracteristica-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                       <div class="form-group">
                                            <label for="strNombre_1">Nombre de Característica (Idioma 1)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de Característica" name="strNombre_1" id="strNombre_1" value="<?php echo $row_DatosConsulta["strNombre_1"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="strNombre_2">Nombre de Característica (Idioma 2)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de Característica" name="strNombre_2" id="strNombre_2" value="<?php echo $row_DatosConsulta["strNombre_2"];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="strNombre_3">Nombre de Característica (Idioma 3)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de Característica" name="strNombre_3" id="strNombre_3" value="<?php echo $row_DatosConsulta["strNombre_3"];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="strNombre_4">Nombre de Característica (Idioma 4)</label>
