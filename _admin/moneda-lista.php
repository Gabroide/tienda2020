...
<head>
    ...
    <title>Administración Tienda | Moneda</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="moneda-add.php" class="btn btn-outline btn-primary" title="Añadir una nueva Moneda">Añadir Moneda</a><br>
<br>
...
<div class="row">
			 ...
			 do { 
				...
				<tr>
					...
					<td><?php echo $row_DatosConsulta["strNombre"];?> - <?php echo $row_DatosConsulta["strSimbolo"];?> 
					<?php if ($row_DatosConsulta["intPrincipal"]==1) 
						echo "[Principal]";
						else
						{
							?>
							<a href="moneda-principal.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>" title="Hacer <?php echo $row_DatosConsulta["strNombre"];?> la moneda principal">Hacer Principal</a>
<?php	}
						?></td>
						<td><?php echo $row_DatosConsulta["dblValor"];?></td>
						<td><?php echo $row_DatosConsulta["strCodificacion"];?></td>											
						<td><a href="moneda-edit.php?id=<?php echo $row_DatosConsulta["idMoneda"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strNombre"];?>"><i class="fa fa-edit"></i></a></td>
				</tr>
