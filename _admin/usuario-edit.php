...
<head>
    ...
    <title>Administración Tienda | Editar Usuario <?php echo $row_DatosConsulta["strNombre"];?></title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="usuario-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" onSubmit="javascript:return validarusuarioeditar();">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Nombre del usuario" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>" required>
                                        </div>
                                        <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                        <div class="form-group">
                                            <label for="strApellidos">Apellidos del Usuario</label>
                                            <input class="form-control" placeholder="Escribir Apellidos del usuario" name="strApellidos" id="strApellidos" value="<?php echo $row_DatosConsulta["strApellidos"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="strNickName">Nombre del Usuario para la Tienda</label>
                                            <input class="form-control" placeholder="Escribir Nombre del usuario para la Tienda" name="strNickName" id="strNickName" value="<?php echo $row_DatosConsulta["strNickName"];?>" required>
                                        </div>                                     
										<div class="form-group">
