...
<head>
    ...
    <title>Administración Tienda | Añadir Detalle</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="opciondetalle-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Nombre del detalle" name="strNombre_1" id="strNombre_1" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_2">Nombre de la Detalle (Idioma 2)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del detalle" name="strNombre_2" id="strNombre_2">
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_3">Nombre de la Detalle (Idioma 3)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del detalle" name="strNombre_3" id="strNombre_3">
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_4">Nombre de la Detalle (Idioma 4)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del detalle" name="strNombre_4" id="strNombre_4">
                                        </div>
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label for="dblIncremento">Incremento</label>
