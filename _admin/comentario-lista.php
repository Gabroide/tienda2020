...
if (isset($_GET["valor"]))
{
	...
	$parametro_orden= "idComentario"; //POR DEFECTO
...
<head>
    ...
    <title>Administración Tienda | Comentarios</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
			 ...
			 do { 
				...
				<tr>
						...
						<td><?php echo DateToHumano($row_DatosConsulta["strFecha"]);?> <?php echo HoraToHumano($row_DatosConsulta["strFecha"]);?></td>
						<td><?php echo $row_DatosConsulta["strNombreComentador"];?></td>
						<td><?php echo nl2br($row_DatosConsulta["txtComentario"]);?></td>
						<td><?php echo MostrarNombreProducto($row_DatosConsulta["refProducto"]);?></td>
						<td></td>
						<td>
						<a href="comentario-aprobar.php?id=<?php echo $row_DatosConsulta["idComentario"];?>" class="btn btn-success btn-circle" title="Publicar Comentario"><i class="fa fa-check "></i></a>
						<a href="comentario-eliminar.php?id=<?php echo $row_DatosConsulta["idComentario"];?>" class="btn btn-danger btn-circle" title="EliminarComentario"><i class="fa fa-times-circle "></i></a>
