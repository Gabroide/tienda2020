...
<head>
    ...
    <title>Administración Tienda | Editar Moneda</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="moneda-edit.php" method="post" id="forminsertar" name="forminsertar" role="form">                                                                           
                                        <div class="form-group">
                                            <label for="strNombre">Nombre Moneda</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la moneda" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="strSimbolo">Símbolo</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Valor de la moneda" name="dblValor" id="dblValor" value="<?php echo $row_DatosConsulta["dblValor"];?>" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="strCodificacion">Codificación </label>
                                            <input class="form-control" placeholder="Escribir Codificación de la moneda" name="strCodificacion" id="strCodificacion" value="<?php echo $row_DatosConsulta["strCodificacion"];?>" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="strHTML">Código HTML </label>
                                            <input class="form-control" placeholder="Escribir CodificaciónHTML dela moneda" name="strHTML" id="strHTML" value="<?php echo $row_DatosConsulta["strHTML"];?>" required>
                                        </div>
