...
<head>
    ...
    <title>Administración Tienda | Impuestos</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="impuesto-add.php" class="btn btn-outline btn-primary" title="Añadir nuevo Impuesto">Añadir Impuesto</a><br>
<br>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td><a href="impuesto-edit.php?id=<?php echo $row_DatosConsulta["idImpuesto"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strNombre"];?>"><i class="fa fa-edit"></i></a></td>
				</tr>
