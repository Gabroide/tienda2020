...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblpreciogrupo SET strNombre_1=%s, strNombre_2=%s, strNombre_3=%s, strNombre_4=%s, intEstado=%s  WHERE idGrupo=%s",
...
<head>
    ...
    <title>Administración Tienda | Editar Descuento Grupo </title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="grupo-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            <label for="strNombe_1">Nombre del Grupo (Idioma 1)</label>
                                        ...
                                        <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                         <div class="form-group">
                                            <label for="strNombe_2">Nombre del Grupo (Idioma 2)</label>
                                         ...
                                         <div class="form-group">
                                            <label for="strNombe_3">Nombre del Grupo (Idioma 3)</label>
                                         ...
                                         <div class="form-group">
                                            <label for="strNombe_4">Nombre del Grupo (Idioma 4)</label>
