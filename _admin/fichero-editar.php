...
if (isset($_POST["fic"]))
{
		...
		$myfile = fopen("../includes/languages/".$_POST["fic"], "w");
...
<head>
    ...
    <title>Administración Tienda | Editar Idioma</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión de Ficheros</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>

            <a href="idioma.php" class="btn btn-outline btn-info" title="Volver atrás">Volver atrás</a><br>
<br>
...
<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <?php
						$contenidofichero=""; 
						 $fh = fopen("../includes/languages/".$_GET["fic"],'r');
						while ($line = fgets($fh)) {
                        ...
                        <div class="panel-body">
							<form action="fichero-editar.php" method="post" name="form1" id="form1" >
  								<label for="contenido" style="display: none">Traducciones</label>
