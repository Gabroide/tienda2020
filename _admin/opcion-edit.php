...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblopcion SET strNombre_1=%s, strNombre_2=%s, strNombre_3=%s, strNombre_4=%s, intEstado=%s, intOrden=%s WHERE idOpcion=%s",
...
<head>
    ...
    <title>Administración Tienda | Editar Opción</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
