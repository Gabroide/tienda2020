...
if ((comprobarseocategoriaunico($_POST["idCategoria"], $_POST["strSEO_1"], 1)) && (comprobarseocategoriaunico($_POST["idCategoria"], $_POST["strSEO_2"], 2)) && (comprobarseocategoriaunico($_POST["idCategoria"], $_POST["strSEO_3"], 3)) &&  (comprobarseocategoriaunico($_POST["idCategoria"], $_POST["strSEO_4"], 4)))
	{
  ...
  $updateSQL = sprintf("UPDATE tblcategoria SET strNombre_1=%s, strNombre_2=%s, strNombre_3=%s, strNombre_4=%s, strSEO_1=%s,strSEO_2=%s,strSEO_3=%s,strSEO_4=%s, intEstado=%s, refPadre=%s, intOrden=%s, intPrincipal=%s WHERE idCategoria=%s",
...
<head>
    ...
    <title>Administración Tienda | Editar Categoría</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="categoria-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                       <div class="form-group">
                                            <label for="strNombre_1">Nombre de categoría (Idioma 1)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del categoría" name="strNombre_1" id="strNombre_1" value="<?php echo $row_DatosConsulta["strNombre_1"];?>" onChange="javascript:document.forminsertar.strSEO_1.value=CodificarSEO(document.forminsertar.strNombre_1.value);" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="strSEO_1">SEO de categoría (Idioma 1)</label>
                                            <input class="form-control" placeholder="Escribir SEO del categoría" name="strSEO_1" id="strSEO_1" value="<?php echo $row_DatosConsulta["strSEO_1"];?>" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_2">Nombre de categoría (Idioma 2)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del categoría" name="strNombre_2" id="strNombre_2" value="<?php echo $row_DatosConsulta["strNombre_2"];?>" onChange="javascript:document.forminsertar.strSEO_2.value=CodificarSEO(document.forminsertar.strNombre_2.value);">
                                        </div>
                                         <div class="form-group">
                                            <label for="strSEO_2">SEO de categoría (Idioma 2)</label>
                                            <input class="form-control" placeholder="Escribir SEO del categoría" name="strSEO_2" id="strSEO_2" value="<?php echo $row_DatosConsulta["strSEO_2"];?>">
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_3">Nombre de categoría (Idioma 3)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del categoría" name="strNombre_3" id="strNombre_3" value="<?php echo $row_DatosConsulta["strNombre_3"];?>" onChange="javascript:document.forminsertar.strSEO_3.value=CodificarSEO(document.forminsertar.strNombre_3.value);">
                                        </div>
                                         <div class="form-group">
                                            <label for="strSEO_3">SEO de categoría (Idioma 3)</label>
                                            <input class="form-control" placeholder="Escribir SEO del categoría" name="strSEO_3" id="strSEO_3" value="<?php echo $row_DatosConsulta["strSEO_3"];?>">
                                        </div>
                                         <div class="form-group">
                                            <label for="strNombre_4">Nombre de categoría (Idioma 4)</label>
                                            <input class="form-control" placeholder="Escribir Nombre del categoría" name="strNombre_4" id="strNombre_4" value="<?php echo $row_DatosConsulta["strNombre_4"];?>" onChange="javascript:document.forminsertar.strSEO_4.value=CodificarSEO(document.forminsertar.strNombre_4.value);">
                                        </div>
                                         <div class="form-group">
                                            <label for="strSEO_4">SEO de categoría (Idioma 4)</label>
                                            <input class="form-control" placeholder="Escribir SEO del categoría" name="strSEO_4" id="strSEO_4" value="<?php echo $row_DatosConsulta["strSEO_4"];?>">
                                        </div>
                                        <div class="form-group">
