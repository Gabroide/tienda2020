...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblimpuesto SET strNombre=%s, dblImpuesto=%s WHERE idImpuesto=%s",
                       GetSQLValueString($_POST["strNombre"], "text"),					   GetSQLValueString(ProcesarComaPrecio($_POST["dblImpuesto"]), "double"),
...
<head>
    ...
    <title>Administración Tienda | Editar Impuesto</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="impuesto-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                      	<div class="form-group">
                                            <label for="strNombre">Nombre Impuesto</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la marca" name="strNombre" id="strNombre" value="<?php echo $row_DatosConsulta["strNombre"];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="dblImpuesto">Valor del Impuesto (%)</label>
                                            <input class="form-control" placeholder="Escribir Valor marca" name="dblImpuesto" id="dblImpuesto" value="<?php echo $row_DatosConsulta["dblImpuesto"];?>">
                                        </div>
