...
{	
  ...
  $updateSQL = sprintf("UPDATE tblreserva SET intEstado=%s  WHERE idReserva=%s",
...
$Result1 = mysqli_query($con, $updateSQL) or die(mysqli_error($con));
  ...
  $updateGoTo = "reserva-lista.php?ver=0";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$query_DatosConsulta = sprintf("SELECT * FROM tblreserva WHERE idReserva=%s", GetSQLValueString($_GET["id"], "int"));
...
<head>
    ...
    <title>Administración Tienda | Tramitar Reserva</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
            ...
            <a href="reserva-lista.php?ver=0" class="btn btn-outline btn-info" title="Volver Atrás">Volver atrás</a><br>
<br>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                  <form action="reserva-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                       <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success" title="Tramitar">Tramitar</button>&nbsp;&nbsp;
									  	<a href="reserva-imprimir.php" class="btn btn-warning" title="Imprimir">Imprimir</a>
                                        <input name="idReserva" type="hidden" id="idReserva" value="<?php echo $row_DatosConsulta["idReserva"];?>">
