...
<head>
    ...
    <title>Administración Tienda | Marcas</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="marca-add.php" class="btn btn-outline btn-primary" title="Añadir una nueva marca">Añadir Marca</a>
	</div>
	<div class="col-lg-7">
	<div class="well">
	...
	<div class="col-lg-2">
		<button type="submit" class="btn btn-success" title="Buscar una marca">Buscar</button>
	</div>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td><a href="marca-edit.php?id=<?php echo $row_DatosConsulta["idMarca"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strMarca"];?>"><i class="fa fa-edit"></i></a></td>
				</tr>
