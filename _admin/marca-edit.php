...
<head>
    ...
    <title>Administración Tienda | Editar Marca</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
     <div class="row">
            ...
            <a href="marca-lista.php" class="btn btn-outline btn-info" title="Volver Atrás">Volver atrás</a><br>
<br>
                                ...
                                <div class="col-lg-6">
                                  <form action="marca-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                      <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Nombre de la marca" name="strMarca" id="strMarca" value="<?php echo $row_DatosConsulta["strMarca"];?>" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="intOrden">Orden de la Marca</label>
                                            <input class="form-control" placeholder="Escribir orden de la marca" name="intOrden" id="intOrden" value="<?php echo $row_DatosConsulta["intOrden"];?>" required>
                                        </div>
                                       <div class="form-group">
											<label for="intEstad">Estado</label>
