                        ...
                        <form action="acceso.php" method="post" id="formacceso" name="formacceso" onSubmit="javascript:return validaraccesoadmin();" role="form">
                            <fieldset>
                                ...
                                <?php if (isset($_GET["error"])){?>
                                   ...
                                   <?php }?>
                                   Usuario de pruebas con acceso restringido: demo@tuhipertiendaonline.com<input class="form-control" placeholder="E-mail" name="strEmail" type="email" autofocus>
                                </div>
                                Contraseña de pruebas con acceso restringido: demo@tuhipertiendaonline.com<div class="alert alert-danger oculto" id="erroremail">E-mail obligatorio</div>
