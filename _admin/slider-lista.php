...
<head>
    ...
    <title>Administración Tienda | Slider</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="slider-add.php" class="btn btn-outline btn-primary" title="Añadir un nuevo producto al Slider">Añadir Slider</a>
	</div>
...
<div class="row">
			 ...
			 do { 
				...
				<tr>
						...
						<img src="../images/slider/<?php echo $row_DatosConsulta["strImagen"];?>" width="100"  alt="<?php echo $row_DatosConsulta["strImagen"];?>"/>
						<?php }
						?></td>
