...
<head>
    ...
    <title>Administración Tienda | Añadir Marca</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="marca-add.php" method="post" id="forminsertar" name="forminsertar" role="form">
                                      	<div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Escribir Nombre de la marca" name="strMarca" id="strMarca" required>
                                      	</div>
                     					<div class="form-group">
                                            <label for="intOrden">Orden</label>
                                            <input class="form-control" placeholder="Escribir Orden" name="intOrden" id="intOrden" required>
                                        </div>                    
									   <div class="form-group">
