...
if (isset($_GET["valor"]))
{
	...
	$parametro_orden= "strNombre_1"; //POR DEFECTO
...
/*************************************************************/
	...
	$query_DatosConsulta = sprintf("SELECT * FROM tblpreciogrupo WHERE refPadre=0 ".$cadenaOrden);
...
<head>
    ...
    <title>Administración Tienda | Descuentos Grupos</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="grupo-add.php" class="btn btn-outline btn-primary" title="Añadir un nuevo grupo">Añadir Grupo</a><br>
<br>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre_1"];?></strong></td>
					<td><?php echo MostrarEstado($row_DatosConsulta["intEstado"]);?></td>
					<td></td>
					<td></td>
					<td></td>
					<td><a href="grupo-edit.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strNombre_1"];?>"><i class="fa fa-edit"></i></a> <a href="grupodetalle-add.php?id=<?php echo $row_DatosConsulta["idGrupo"];?>" class="btn btn-success btn-circle" title="Añadir grupo a <?php echo $row_DatosConsulta["strNombre_1"];?>"><i class="fa fa-plus"></i></a>	</td>
				</tr>
              		
              		<?php
				gruponiveladministracion($row_DatosConsulta["idGrupo"], "---- ");
