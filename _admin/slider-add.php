...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $insertSQL = sprintf("INSERT INTO tblslider(strTexto_1, strNOmbre_1, strImagen, strLink_1, intEstado,  intOrden) VALUES (%s, %s, %s, %s, %s)",
                            ...
                            <form action="slider-add.php" method="post" id="forminsertar" name="forminsertar" role="form"><div class="row">
                                <div class="col-lg-6">
                                       <div class="form-group">
                                            <label for="strNombre_1">Nombre Producto</label>
                                            <input class="form-control" placeholder="Escribir nombre del producto" name="strNombre_1" id="strNombre_1" >
                                        </div>                                  
                                        <div class="form-group">
                                            <label for="strLink_1">Link Destino</label>
                                            <input class="form-control" placeholder="Escribir Link" name="strLink_1" id="strLink_1" >
                                        </div>
                                          <div class="form-group">
                                            <label for="strTexto_1">Descripción</label>
                                            <textarea name="strTexto_1" id="strTexto_1">Escribir Texto</textarea>                                           
                                        </div>                                        
                                          <div class="form-group">
