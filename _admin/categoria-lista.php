...
<head>
    ...
    <title>Administración Tienda | Categorías</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					...
					<td><?php echo $row_DatosConsulta["intOrden"];?></td><td></td>
					<td><a href="categoria-edit.php?id=<?php echo $row_DatosConsulta["idCategoria"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strNombre_1"];?>"><i class="fa fa-edit"></i></a> 	<a href="categoria-delete.php?id=<?php echo $row_DatosConsulta["idCategoria"];?>" class="btn btn-danger btn-circle" title="Eliminar <?php echo $row_DatosConsulta["strNombre_1"];?>"><i class="fa fa-times-circle "></i></a></td>
				</tr>
