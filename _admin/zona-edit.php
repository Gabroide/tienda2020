...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $updateSQL = sprintf("UPDATE tblzona SET strNombre_1=%s, strNombre_2=%s, strNombre_3=%s, strNombre_4=%s, intEstado=%s  WHERE idZona=%s",
...
<head>
    ...
    <title>Administración Tienda | Editar Zona</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="zona-edit.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                       <div class="form-group">
                                            <label for="strNombre_1">Nombre de Zona (Idioma 1)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre_1" id="strNombre_1" value="<?php echo $row_DatosConsulta["strNombre_1"];?>">
                                        </div>
                                          <div class="alert alert-danger oculto" id="errornombre">Nombre obligatorio</div>
                                        <div class="form-group">
                                            <label for="strNombre_2">Nombre de Zona (Idioma 2)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre_2" id="strNombre_2" value="<?php echo $row_DatosConsulta["strNombre_2"];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="strNombre_3">Nombre de Zona (Idioma 3)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre_3" id="strNombre_3" value="<?php echo $row_DatosConsulta["strNombre_3"];?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="strNombre_4">Nombre de Zona (Idioma 4)</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre_4" id="strNombre_4" value="<?php echo $row_DatosConsulta["strNombre_4"];?>">
                                        </div>
									   <div class="form-group">
