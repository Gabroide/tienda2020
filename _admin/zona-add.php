...
<head>
    ...
    <title>Administración Tienda | Añadir Zona</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="zona-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            <label for="strNombre_1">Nombre de la Zona</label>
                                            <input class="form-control" placeholder="Escribir Nombre de la zona" name="strNombre_1" id="strNombre_1" required>
                                        </div>
