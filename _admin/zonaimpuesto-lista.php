...
if (isset($_GET["valor"]))
{
	switch ($_GET["valor"]) {
    case 1:
        $parametro_orden= "idZonaImpuesto";
        break;
    case 2:
...
/*************************************************************/
	...
	$query_DatosConsulta = sprintf("SELECT * FROM tblzonaimpuesto".$cadenaOrden);
...
<head>
    ...
    <title>Administración Tienda | Zona Impuestos</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="zonaimpuesto-add.php" class="btn btn-outline btn-primary" title="Añadir Zona Impuesto">Añadir Zona Impuesto</a><br>
<br>
...
<div class="row">
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<tr>
					<td><?php echo $row_DatosConsulta["idZonaImpuesto"];?></td>						
					<td><strong><?php echo $row_DatosConsulta["strNombre"];?></strong></td>
					<td><?php echo MostrarEstado($row_DatosConsulta["intEstado"]);?></td>
					<td><?php echo $row_DatosConsulta["dblCoste"];?></td>						
					<td><a href="zonaimpuesto-edit.php?id=<?php echo $row_DatosConsulta["idZonaImpuesto"];?>" class="btn btn-warning btn-circle" title="Editar <?php echo $row_DatosConsulta["strNombre"];?>"><i class="fa fa-edit"></i></a> 	</td>
				</tr>
