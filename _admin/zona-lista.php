...
if (isset($_GET["valor"]))
{
    ...
    case 1:
        ...
        break;
    case 2:
        $parametro_orden= "strNombre_"._idiomaactual;
        break;
    case 3:
	...
	$parametro_orden= "strNombre_"._idiomaactual; //POR DEFECTO
...
<head>
    ...
    <title>Administración Tienda | Zonas</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
...
<div class="row">
	<div class="col-lg-5">
		<a href="zona-add.php" class="btn btn-outline btn-primary" title="Añadir Nueva Zona">Añadir Zona</a><br>
<br>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Estado <?php
												...
												?></th>
                                            <th>Inferior</th>                
                                            <th>Superior</th>                 <th>Incremento</th>             
                                            <th>Acciones</th>
                                        </tr>
                                    </thead>
                                    <tbody>
		...
		//AQUI ES DONDE SE SACAN LOS DATOS, SE COMPRUEBA QUE HAY RESULTADOS
			 ...
			 do { 
				...
				<td><?php echo $row_DatosConsulta["idZona"];?></td>
					...
					<td><strong><?php echo $row_DatosConsulta["strNombre_"._idiomaactual];?></strong></td>
						<td><?php echo MostrarEstado($row_DatosConsulta["intEstado"]);?></td>
						<td></td>
						<td></td>
						<td></td>
					<td><a href="zona-edit.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-warning btn-circle" title="Editar Zona <?php echo $row_DatosConsulta["strNombre_"._idiomaactual];?>"><i class="fa fa-edit"></i></a> <a href="zonadetalle-add.php?id=<?php echo $row_DatosConsulta["idZona"];?>" class="btn btn-success btn-circle" title="Añadir Peso a <?php echo $row_DatosConsulta["strNombre_"._idiomaactual];?>"><i class="fa fa-plus"></i></a>	</td>
				</tr>
