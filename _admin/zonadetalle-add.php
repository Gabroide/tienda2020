...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "forminsertar")) {
  ...
  $insertSQL = sprintf("INSERT INTO tblzona(strNombre_1, intEstado, refPadre, dblInferior, dblSuperior, dblCoste) VALUES (%s, %s, %s, %s, %s, %s)",
...
<head>
    ...
    <title>Administración Tienda | Crear Grupo</title>
    <!-- InstanceEndEditable -->
    <!-- Bootstrap Core CSS -->
                                ...
                                <div class="col-lg-6">
                                  <form action="zonadetalle-add.php" method="post" id="forminsertar" name="forminsertar" role="form" >
                                        <div class="form-group">
                                            <label for="strNombre_1">Nombre de la Área</label>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input class="form-control" value="0" name="dblInferior" id="dblInferior" required>
                                        </div>
                                         <div class="form-group">
                                            <label for="dblSuperior">Peso Superior</label>
                                            <input class="form-control" value="0" name="dblSuperior" id="dblSuperior" required>
                                        </div>
                                        <div class="form-group">
